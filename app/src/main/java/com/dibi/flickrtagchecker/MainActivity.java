...
public class MainActivity extends FragmentActivity
{
    ...
    private class GetSomeTask extends AsyncTask<String, Integer, Double>
    {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("tabTitles").setIndicator("TITLES"),
                TitlesFragment.class, null);
        mTabHost.addTab(mTabHost.newTabSpec("tabList").setIndicator("LIST"),
                ListFragment.class, null);
        mTabHost.addTab(mTabHost.newTabSpec("tabGrid").setIndicator("GRID"),
